...
extension NoteEntityQueryFilter
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> dataIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> dataIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> dataEqualTo(
    String? value, {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> dataGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> dataLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> dataBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> dataStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> dataEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> dataContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> dataMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> dataIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'data',
        value: '',
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterFilterCondition> dataIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'data',
        value: '',
...
extension NoteEntityQuerySortBy
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> sortByData() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'data', Sort.asc);
    });
  }

  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> sortByDataDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteEntityQuerySortThenBy
  ...
  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> thenByData() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'data', Sort.asc);
    });
  }

  QueryBuilder<NoteEntity, NoteEntity, QAfterSortBy> thenByDataDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'data', Sort.desc);
    });
  }
...
extension NoteEntityQueryWhereDistinct
  ...
  QueryBuilder<NoteEntity, NoteEntity, QDistinct> distinctByData(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension NoteEntityQueryProperty
  ...
  QueryBuilder<NoteEntity, String?, QQueryOperations> dataProperty() {
    return QueryBuilder.apply(this, (query) {
