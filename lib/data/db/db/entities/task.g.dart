...
extension TaskEntityQueryFilter
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterFilterCondition> dataIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterFilterCondition> dataIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterFilterCondition> dataEqualTo(
    String? value, {
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterFilterCondition> dataGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterFilterCondition> dataLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterFilterCondition> dataBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterFilterCondition> dataStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterFilterCondition> dataEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterFilterCondition> dataContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterFilterCondition> dataMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterFilterCondition> dataIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'data',
        value: '',
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterFilterCondition> dataIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'data',
        value: '',
...
extension TaskEntityQuerySortBy
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterSortBy> sortByData() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'data', Sort.asc);
    });
  }

  QueryBuilder<TaskEntity, TaskEntity, QAfterSortBy> sortByDataDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskEntityQuerySortThenBy
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterSortBy> thenByData() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'data', Sort.asc);
    });
  }

  QueryBuilder<TaskEntity, TaskEntity, QAfterSortBy> thenByDataDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'data', Sort.desc);
    });
  }
...
extension TaskEntityQueryWhereDistinct
  ...
  QueryBuilder<TaskEntity, TaskEntity, QDistinct> distinctByData(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TaskEntityQueryProperty
  ...
  QueryBuilder<TaskEntity, String?, QQueryOperations> dataProperty() {
    return QueryBuilder.apply(this, (query) {
